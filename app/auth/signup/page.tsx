        ...
        <div className="bg-white px-8 py-10 shadow-[0_4px_40px_rgba(0,0,0,0.06)]">
          ...
          {success ? (
            <div className="text-center py-4">
              ...
              <h2 className="font-serif text-xl font-semibold text-lux-ink mb-2">
                Account Created!
              </h2>
              <p className="text-sm text-lux-ink/50 font-light leading-relaxed mb-6">
                We&apos;ve sent a confirmation link to <strong className="text-lux-ink/70">{email}</strong>.
                Please check your inbox to verify your account.
              </p>
              <Link
                href="/auth/login"
                className="inline-flex items-center px-7 py-3 bg-lux-gold text-white text-[0.7rem] tracking-[0.2em] uppercase font-medium hover:bg-lux-gold-hover transition-colors duration-200"
              >
                Go to Login
              </Link>
            </div>
            ...
            <>
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                {/* Full Name */}
                <div>
                  <label htmlFor="fullName" className="block text-[0.68rem] tracking-[0.18em] uppercase text-lux-ink/55 font-medium mb-1.5">
                    Full Name
                  </label>
                  <div className="relative">
                    <User size={15} strokeWidth={1.5} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-lux-ink/30" />
                    <input
                      id="fullName"
                      type="text"
                      value={fullName}
                ...
                {/* Password */}
                <div>
                  <label htmlFor="password" className="block text-[0.68rem] tracking-[0.18em] uppercase text-lux-ink/55 font-medium mb-1.5">
                    Password
                  </label>
                  <div className="relative">
                  ...
                  {strength && (
                    <div className="mt-2">
                      <div className="h-1 w-full bg-lux-ink/8 rounded-full overflow-hidden">
                ...
                {/* Confirm Password */}
                <div>
                  <label htmlFor="confirm" className="block text-[0.68rem] tracking-[0.18em] uppercase text-lux-ink/55 font-medium mb-1.5">
                    Confirm Password
                  </label>
                  <div className="relative">
                    <Lock size={15} strokeWidth={1.5} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-lux-ink/30" />
                    <input
                      ...
                      className={`w-full pl-10 pr-11 py-3 border bg-lux-ivory text-sm text-lux-ink placeholder:text-lux-ink/25 focus:outline-none transition-colors duration-200 ${
                        mismatch ? 'border-red-400 focus:border-red-400' : 'border-lux-ink/15 focus:border-lux-gold'
                      }`}
                    />
                    <button
                      type="button"
                ...
                <label className="flex items-start gap-2.5 cursor-pointer group pt-1">
                  <span
                    className={`w-4 h-4 flex-shrink-0 border transition-colors duration-150 flex items-center justify-center mt-0.5 ${
                      agreed ? 'border-lux-gold bg-lux-gold' : 'border-lux-ink/25 group-hover:border-lux-gold'
                    }`}
                  >
                    {agreed && (
                  ...
                  <span className="text-xs text-lux-ink/50 font-light leading-relaxed">
                    I agree to the{' '}
                    <Link href="/terms" className="text-lux-gold hover:underline underline-offset-2">Terms of Service</Link>
                    {' '}and{' '}
                    <Link href="/privacy" className="text-lux-gold hover:underline underline-offset-2">Privacy Policy</Link>
                  </span>
                </label>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 bg-lux-gold text-white text-[0.72rem] tracking-[0.22em] uppercase font-medium hover:bg-lux-gold-hover disabled:opacity-70 disabled:cursor-not-allowed transition-colors duration-200 mt-1"
                >
                  {loading ? (
                    <>
              ...
              <p className="text-center text-xs text-lux-ink/40 font-light mt-7">
                ...
                <Link href="/auth/login" className="text-lux-gold font-medium hover:underline underline-offset-2">
                  Sign in
                </Link>
              </p>
            </>
