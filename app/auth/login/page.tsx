      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white px-8 py-10 shadow-[0_4px_40px_rgba(0,0,0,0.06)]">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="password" className="text-[0.68rem] tracking-[0.18em] uppercase text-[#1A1A1A]/55 font-medium">
                  Password
                </label>
                <Link href="/auth/forgot-password" className="text-[0.65rem] text-[#C6973F] hover:underline underline-offset-2 transition-all duration-150">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
            ...
            <label className="flex items-center gap-2.5 cursor-pointer group">
              <span
                className={`w-4 h-4 flex-shrink-0 border transition-colors duration-150 flex items-center justify-center ${
                  remember ? 'border-[#C6973F] bg-[#C6973F]' : 'border-[#1A1A1A]/25 group-hover:border-[#C6973F]'
                }`}
              >
                {remember && (
              ...
              <span className="text-xs text-[#1A1A1A]/55 font-light">Remember me</span>
            </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3.5 bg-[#C6973F] text-white text-[0.72rem] tracking-[0.22em] uppercase font-medium hover:bg-[#b5872e] disabled:opacity-70 disabled:cursor-not-allowed transition-colors duration-200 mt-2"
            >
              {loading ? (
                <>
          ...
          <p className="text-center text-xs text-[#1A1A1A]/40 font-light mt-7">
            ...
            <Link href="/auth/signup" className="text-[#C6973F] font-medium hover:underline underline-offset-2">
              Create one
            </Link>
          </p>
        </div>
