  ...
  return (
    <div className="bg-lux-ivory">
      ...
      <section className="border-b border-lux-gold/10 px-4 py-10 text-center md:py-12">
        ...
        <h1 className="font-serif text-4xl md:text-5xl font-semibold text-lux-ink mb-3">Privacy Policy</h1>
        <GoldDivider />
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
        <div className="bg-white border border-lux-ink/8 p-8 md:p-12 space-y-10">
            ...
            <ul className="space-y-2 ml-4">
              {[
                ...
                <li key={item} className="flex items-start gap-2.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-lux-gold flex-shrink-0 mt-2" />
                  {item}
                </li>
              ))}
            </ul>
          ...
          <Section title="7. Your Rights">
            ...
            <p>To exercise any of these rights, email us at <a href="mailto:hello@aahvani.com" className="text-lux-gold hover:underline">hello@aahvani.com</a>.</p>
          </Section>
          ...
          <Section title="10. Contact Us">
            ...
            <div className="bg-lux-gold/6 border border-lux-gold/15 p-4 mt-2 space-y-1">
              ...
              <p><span className="font-medium text-lux-ink/80">Phone:</span> +91 98765 43210</p>
            </div>
          </Section>
